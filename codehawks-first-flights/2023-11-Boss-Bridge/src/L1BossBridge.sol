...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    function depositTokensToL2(
         ...
         * Issue: Anyone can deposit from other addresses they do not control with the 'l2Recipient' parameter.
         * Impact: Attacker could deposit from other addresses into their own address.
         * Also anyone can deposit to any address (ex. their own)
         * Risk: Medium?
         * Fix: Change 'from' to messager.sender?
         */

        /**
         * @audit-okay [depositTokensToL2-checkBalance]
         * safeTransferFrom will revert in ERC20InsufficientBalance
         */
    ...
    function withdrawTokensToL1(
        ...
        sendToL1(
            ...
            s,
            /**
             * @audit-okay Who's the signer of this message? It is message.sender?
             * A: operator, ex. testUserCanWithdrawTokensWithOperatorSignature
             * This function has no auth but sendToL1 checks message signer is a authorized signer.
             */
            abi.encode(
                address(token),
                0, // value
