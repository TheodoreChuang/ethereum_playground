...
function App() {
  ...
  const openPosition = async e => {
    ...
    console.log("🚀 ~ openPosition ~ tx2", tx2);
    await tx2.wait();
  };
  ...
  const closePosition = async e => {
    ...
    console.log("🚀 ~ file: App.js ~ line 43 ~ App ~ tx1", tx1);
    await tx1.wait();
    const tx2 = await yieldFarmer.closePosition(addresses.solo, addresses.dai, addresses.cDai);
    console.log("🚀 ~ file: App.js ~ line 46 ~ App ~ tx2", tx2);
    await tx2.wait();
  };
      ...
      <div className="row">
        <div className="col-sm-6">
          ...
          <form className="form-inline" onSubmit={e => openPosition(e)}>
            <input type="text" className="form-control mb-2 mr-sm-2" placeholder="Amount provided (DAI)" />
            <input type="text" className="form-control mb-2 mr-sm-2" placeholder="Amount borrowed (DAI)" />
